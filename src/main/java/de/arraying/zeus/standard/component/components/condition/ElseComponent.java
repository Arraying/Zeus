package de.arraying.zeus.standard.component.components.condition;
...
import de.arraying.zeus.standard.component.ZeusScopeComponent;
...
public class ElseComponent implements ZeusScopeComponent {
    ...
    public boolean invoke(ZeusTaskImpl task, Token[] tokens, int lineNumber) throws ZeusException {
        ...
        if(tokens.length != 1) {
            throw new ZeusException("Expected just the else keyword, nothing else.", lineNumber);
        }
